/**
 * Формирование ссылки (endsWith)
 * Написать скрипт, который проверяет заканчивается ли значение
* переменной linkсимволом /. еслс нет, то добавить до конца
* значения link этот символ.
